package oit.is.team1.lec05.security;
...
public class Sample3AuthConfiguration {
  ...
  public InMemoryUserDetailsManager userDetailsService() {
    ...
    UserDetails customer1 = User.withUsername("customer1")
        .password("{bcrypt}$2y$10$sVZY4VfjNJ932prKPrCHA.FCtXr7UGAo/TkKPG.52PgdNFtk53Yya")
        .roles("CUSTOMER")
        .build();
    // $ sshrun htpasswd -nbBC 10 customer2 p@ss
    UserDetails customer2 = User.withUsername("customer2")
        .password("{bcrypt}$2y$10$XXsbo7z3g5ESgStMJBFyk.TAB4SXLmJ98FNJzdkUDkIYjtHETS542")
        .roles("CUSTOMER")
        .build();
    // $ sshrun htpasswd -nbBC 10 seller p@ss
    UserDetails seller = User.withUsername("seller")
        .password("{bcrypt}$2y$10$8glofigscyg6QRGG25vdau2ScXFV7uhmN2X5eZJx6.VZwPdIr7ZEa")
        .roles("SELLER")
        .build();
